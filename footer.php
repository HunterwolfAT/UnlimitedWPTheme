<div class="footer">
    <div class="container-3 w-container"><img src="https://unlimitedammo.de/wp-content/themes/UA-html5blank/custom-assets/images/signet.png" width="100" class="image-22">
      <div class="ua-social-footer">
        ...
        <a href="#" class="profile ua-social-button w-clearfix w-inline-block">
          <div class="button-icon facebook"></div>
          <div class="button-text">Facebook</div>
        </a-->
      </div>
      <div class="div-block-37">
	<?php html5blank_nav(); ?>
	<!--a href="#" class="footerlink">Impressum</a><a href="#" class="footerlink">Legal</a><a href="#" class="footerlink">home</a-->
	</div>
    </div>
  </div>
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.2.0/jquery.min.js" type="text/javascript"></script>
  <script src="https://unlimitedammo.de/wp-content/themes/UA-html5blank/custom-assets/js/webflow.js" type="text/javascript"></script>
